...
const Sidebar = () => {
    ...
    return (
        <div className='nav-bar'>
            ...
            <nav>
                <NavLink exact="true" activeclassname="active" to="/" className="marginLeft">
            ...
            <ul>
                <li>
                    <a target="_blank" rel='noreferrer' href='https://www.linkedin.com/in/adrian-ukwunna-962461154/'>
                        <FontAwesomeIcon icon={faLinkedin} color="#4d4d4e" />
                    </a>
                </li>
                <li>
                    <a target="_blank" rel='noreferrer' href='https://github.com/the-adrianator'>
